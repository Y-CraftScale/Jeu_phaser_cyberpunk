// src/scenes/GameSceneSoloMap2.js
...
export default class GameSceneSoloMap2 extends Phaser.Scene {
  ...
  create(){
    // --- State/Inventory
    this._leaving=false;
    this.inventory = this._incomingData?.inventory instanceof InventoryManager
      ? this._incomingData.inventory
    ...
    this.createExitZoneIfOpen=()=>{
      ...
      this.physics.add.overlap(this.player,this.exitZone,()=>{
        ...
        // Prochaine scène à enchaîner
        this.scene.start('GameSceneSoloMap3',{ inventory:this.inventory });
      });
    };
  }
